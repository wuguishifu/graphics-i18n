    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.caption}>
          ...
          asset overrides at render time.
        </Text>
        ...
        <View style={styles.localeRow}>
          {LOCALES.map(({ code, label }) => (
            ...
            >
              <Text style={[styles.pillLabel, locale === code && styles.pillLabelActive]}>{label}</Text>
            </Pressable>
          ))}
        </View>
        ...
        <View style={styles.notes}>
          <Text style={styles.note}>• fr — longer title shrinks to fit, wider text box, blue logo (asset override), patched title color</Text>
          <Text style={styles.note}>• ar — RTL: text aligns right, patch mirrors the logo and accent bar</Text>
          <Text style={styles.note}>• ja — not in the package, falls back to en</Text>
          <Text style={styles.note}>• “terms” is only translated in en — other locales fall back per string (see debug overlay)</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
